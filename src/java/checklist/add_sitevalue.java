...
//           UPDATE ENTRIES
               ...
               String update_htc="UPDATE htc_site SET recounted_data='"+recounted_data+"', reported_711A='"+reported_711A+"' ,reported_DHIS='"+reported_DHIS+"', timestamp='"+timestamp+"' WHERE id='"+found+"'";
...
//             INSERTED AS A NEW ENTRY   
              //  String insert_htc="INSERT INTO htc_site (id,hf_id,indicator_id,recounted_data,reported_711A,reported_731,reported_DHIS,year,month,date,timestamp,datekey) VALUES"
               //         + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_731+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"','"+datekey+"')";
                ...
                String insert_htc="INSERT INTO htc_site (id,hf_id,indicator_id,recounted_data,datamonthlyreport,reported_DHIS,year,month,date,timestamp,datekey) VALUES"
                        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"','"+datekey+"')";
...
//             INSERTED AS A NEW ENTRY   
               // String insert_pmtct="INSERT INTO pmtct_site (id,hf_id,indicator_id,recounted_data,reported_711A,reported_731,reported_DHIS,year,month,date,timestamp,datekey) VALUES"
                ...
                String insert_pmtct="INSERT INTO pmtct_site (id,hf_id,indicator_id,recounted_data,datamonthlyreport,reported_DHIS,year,month,date,timestamp,datekey) VALUES"
                        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"','"+datekey+"')";
...
//             INSERTED AS A NEW ENTRY   
               // String insert_caretreatment="INSERT INTO caretreatment_site (id,hf_id,indicator_id,recounted_data,reported_711A,reported_731,reported_DHIS,year,month,date,timestamp,datekey) VALUES"
                ...
                String insert_caretreatment="INSERT INTO caretreatment_site (id,hf_id,indicator_id,recounted_data,datamonthlyreport,reported_DHIS,year,month,date,timestamp,datekey) VALUES"
                        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"','"+datekey+"')";
...
//             INSERTED AS A NEW ENTRY   
               // String insert_tb="INSERT INTO tb_site (id,hf_id,indicator_id,recounted_data,reported_711A,reported_731,reported_DHIS,year,month,date,timestamp,datekey) VALUES"
                //        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_731+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"','"+datekey+"')";
                String insert_tb="INSERT INTO tb_site (id,hf_id,indicator_id,recounted_data,datamonthlyreport,reported_DHIS,year,month,date,timestamp,datekey) VALUES"
                        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"','"+datekey+"')";
...
//           UPDATE ENTRIES
              // String update_vmmc="UPDATE vmmc_site SET recounted_data='"+recounted_data+"', reported_711A='"+reported_711A+"', reported_731='"+reported_731+"',reported_DHIS='"+reported_DHIS+"', timestamp='"+timestamp+"' WHERE id='"+found+"'";
               String update_vmmc="UPDATE vmmc_site SET recounted_data='"+recounted_data+"', datamonthlyreport='"+reported_711A+"',reported_DHIS='"+reported_DHIS+"', timestamp='"+timestamp+"' WHERE id='"+found+"'";
...
//             INSERTED AS A NEW ENTRY   
               ...
               //         + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_731+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"','"+datekey+"')";
                ...
                String insert_vmmc="INSERT INTO vmmc_site (id,hf_id,indicator_id,recounted_data,datamonthlyreport,reported_DHIS,year,month,date,timestamp,datekey) VALUES"
                        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"','"+datekey+"')";
