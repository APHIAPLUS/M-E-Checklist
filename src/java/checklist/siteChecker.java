...
String found,data;
String  indicator_name,indicator_id,datamonthlyreport,program_area,source_doc,recounted_data,reported_711A,reported_731,reported_DHIS,section;
int position;
String sectionHTC,sectionPMTCT,sectionCARE,sectionTB,sectionVMMC,id,formAction,hf_name;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       sectionHTC="<div id=\"step-3\" style=\"width:900px;\">" +
...
"    <col width=\"70px\">";
  ...
  sectionPMTCT="<div id=\"step-1\" style=\"width:900px;\" >" +
...
sectionCARE=" <div id=\"step-2\" style=\"width:900px;\" >" +
...
sectionVMMC=" <div id=\"step-4\" style=\"width:900px;\" >" +
...
sectionTB=" <div id=\"step-5\" style=\"width:900px;\" >" +
...
//      LOAD HTC DATA TO A BEAN................
         String get_htcSite="SELECT htc_site.id,htc_site.indicator_id,indicators.indicator,htc_site.recounted_data,htc_site.reported_711A,htc_site.reported_731,htc_site.reported_DHIS,indicators.section,htc_site.datamonthlyreport "
 ...
 sectionHTC+=" <tr>"
        ...
        //      LOAD PMTCT DATA TO A BEAN................
         String get_pmtctSite="SELECT pmtct_site.id,pmtct_site.indicator_id,indicators.indicator,pmtct_site.recounted_data,pmtct_site.reported_711A,pmtct_site.reported_731,pmtct_site.reported_DHIS,indicators.section "
                 + ",pmtct_site.datamonthlyreport FROM pmtct_site JOIN indicators ON pmtct_site.indicator_id=indicators.id WHERE pmtct_site.year='"+year+"' && pmtct_site.month="+month+" && pmtct_site.hf_id='"+hfid+"'  ORDER BY pmtct_site.indicator_id";
 ...
 sectionPMTCT+=" <tr>"
         ...
         String get_caretreatmentSite="SELECT caretreatment_site.id,caretreatment_site.indicator_id,indicators.indicator,caretreatment_site.recounted_data,caretreatment_site.reported_711A,caretreatment_site.reported_731,caretreatment_site.reported_DHIS,indicators.section "
                 + ",caretreatment_site.datamonthlyreport FROM caretreatment_site JOIN indicators ON caretreatment_site.indicator_id=indicators.id WHERE caretreatment_site.year='"+year+"' && caretreatment_site.month="+month+" && caretreatment_site.hf_id='"+hfid+"'  ORDER BY caretreatment_site.indicator_id";
 ...
 sectionCARE+=" <tr>"
         ...
         String get_tbSite="SELECT tb_site.id,tb_site.indicator_id,indicators.indicator,tb_site.recounted_data,tb_site.reported_711A,tb_site.reported_731,tb_site.reported_DHIS,indicators.section "
                 + ",tb_site.datamonthlyreport FROM tb_site JOIN indicators ON tb_site.indicator_id=indicators.id WHERE tb_site.year='"+year+"' && tb_site.month="+month+" && tb_site.hf_id='"+hfid+"'  ORDER BY tb_site.indicator_id";
...
//             reported_731=conn.rs.getString(6);
 ...
 sectionTB+=" <tr>"
         ...
         String get_vmmcSite="SELECT vmmc_site.id,vmmc_site.indicator_id,indicators.indicator,vmmc_site.recounted_data,vmmc_site.reported_711A,vmmc_site.reported_731,vmmc_site.reported_DHIS,indicators.section "
                 + ",vmmc_site.datamonthlyreport FROM vmmc_site JOIN indicators ON vmmc_site.indicator_id=indicators.id WHERE vmmc_site.year='"+year+"' && vmmc_site.month="+month+" && vmmc_site.hf_id='"+hfid+"'  ORDER BY vmmc_site.indicator_id";
...
"                <span class=\"stepDesc\">" +
"<!--                   Step 1<br />-->" +
"            <small style=\"font-size: 14px;\"><b>PMTCT-ANC & Labour & Delivery</b></small>" +
"                </span>" +
"            </a></li>" +
...
"                <span class=\"stepDesc\">" +
"<!--                   Step 4<br />-->" +
"                  <small style=\"font-size: 22px;\"><b>VMMC</b></small>" +
"                </span>                   " +
"            </a></li>" +        
...
"  			</ul>";
    ...
    data+=sectionHTC+""+sectionPMTCT+""+sectionCARE+""+sectionVMMC+""+sectionTB+"</div>" +
