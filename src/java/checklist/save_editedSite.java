...
//           UPDATE ENTRIES
              // String update_htc="UPDATE htc_site SET recounted_data='"+recounted_data+"', reported_711A='"+reported_711A+"', reported_731='"+reported_731+"',reported_DHIS='"+reported_DHIS+"', timestamp='"+timestamp+"' WHERE id='"+found+"'";
               String update_htc="UPDATE htc_site SET recounted_data='"+recounted_data+"', datamonthlyreport='"+reported_711A+"',reported_DHIS='"+reported_DHIS+"', timestamp='"+timestamp+"' WHERE id='"+found+"'";
...
//             INSERTED AS A NEW ENTRY   
               ...
               //         + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_731+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"')";
                ...
                String insert_htc="INSERT INTO htc_site (id,hf_id,indicator_id,recounted_data,datamonthlyreport,reported_DHIS,year,month,date,timestamp) VALUES"
                        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"')";
...
//           UPDATE ENTRIES
             //  String update_pmtct="UPDATE pmtct_site SET recounted_data='"+recounted_data+"', reported_711A='"+reported_711A+"', reported_731='"+reported_731+"',reported_DHIS='"+reported_DHIS+"', timestamp='"+timestamp+"' WHERE id='"+found+"'";
               String update_pmtct="UPDATE pmtct_site SET recounted_data='"+recounted_data+"', datamonthlyreport='"+reported_711A+"',reported_DHIS='"+reported_DHIS+"', timestamp='"+timestamp+"' WHERE id='"+found+"'";
...
//             INSERTED AS A NEW ENTRY   
                ...
                String insert_pmtct="INSERT INTO pmtct_site (id,hf_id,indicator_id,recounted_data,datamonthlyreport,reported_DHIS,year,month,date,timestamp) VALUES"
                        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"')";
...
//           UPDATE ENTRIES
               ...
               String update_caretreatment="UPDATE caretreatment_site SET recounted_data='"+recounted_data+"', datamonthlyreport='"+reported_711A+"',reported_DHIS='"+reported_DHIS+"', timestamp='"+timestamp+"' WHERE id='"+found+"'";
                    System.out.println("update care: "+update_caretreatment);
               conn.st.executeUpdate(update_caretreatment);
           }
            if(found.equals("")){
//             INSERTED AS A NEW ENTRY   
                String insert_caretreatment="INSERT INTO caretreatment_site (id,hf_id,indicator_id,recounted_data,datamonthlyreport,reported_DHIS,year,month,date,timestamp) VALUES"
                        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"')";
                  System.out.println("insert care: "+insert_caretreatment);
...
//           UPDATE ENTRIES
               ...
               String update_tb="UPDATE tb_site SET recounted_data='"+recounted_data+"', datamonthlyreport='"+reported_711A+"',reported_DHIS='"+reported_DHIS+"', timestamp='"+timestamp+"' WHERE id='"+found+"'";
...
//             INSERTED AS A NEW ENTRY   
               ...
               //         + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_731+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"')";
                ...
                String insert_tb="INSERT INTO tb_site(id,hf_id,indicator_id,recounted_data,datamonthlyreport,reported_DHIS,year,month,date,timestamp) VALUES"
                        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"')";
...
//           UPDATE ENTRIES
               ...
               String update_tb="UPDATE vmmc_site SET recounted_data='"+recounted_data+"', datamonthlyreport='"+reported_711A+"',reported_DHIS='"+reported_DHIS+"', timestamp='"+timestamp+"' WHERE id='"+found+"'";
               conn.st.executeUpdate(update_tb);
           }
            if(found.equals("")){
//             INSERTED AS A NEW ENTRY   
                ...
                String insert_tb="INSERT INTO vmmc_site(id,hf_id,indicator_id,recounted_data,datamonthlyreport,reported_DHIS,year,month,date,timestamp) VALUES"
                        + "('"+id+"','"+hf_id+"','"+indicator_id+"','"+recounted_data+"','"+reported_711A+"','"+reported_DHIS+"','"+year+"','"+month+"','"+date+"','"+timestamp+"')";
