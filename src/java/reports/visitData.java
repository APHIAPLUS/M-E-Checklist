...
//       GET ALL DATA FOR THIS MONTH............................
           int p=0;
       String getHTC="SELECT sum(recounted_data),sum(reported_711A),sum(reported_731),sum(reported_DHIS),indicator_id FROM htc_site WHERE hf_id='"+facility_id+"' && year='"+year+"' && month='"+month+"'";
...
//               System.out.println("here htc......."+facility_id);
         ...
         htc_Data=htc_711A=htc_731=htc_DHIS=0;
          ...
          htc_Data1=""+conn.rs.getInt(1);
          htc_711A1=""+conn.rs.getInt(2);
          htc_7311=""+conn.rs.getInt(3);
          htc_DHIS1=""+conn.rs.getInt(4);
...
//      System.out.println(" id  htc :  "+conn.rs.getString(5));          
     ...
     if(!htc_DHIS1.equals("")){rw1cell13.setCellValue(Integer.parseInt(htc_DHIS1));rw1cell13.setCellStyle(style_green);}
         ...
         p=0;
       String getPMTC="SELECT sum(recounted_data),sum(reported_711A),sum(reported_731),sum(reported_DHIS),indicator_id FROM pmtct_site WHERE hf_id='"+facility_id+"' && year='"+year+"' && month='"+month+"'";
...
//               System.out.println("here pmtct......."+facility_id);
         ...
         pmtct_Data1=""+conn.rs.getInt(1);
         pmtct_711A1=""+conn.rs.getInt(2);
         pmtct_7311=""+conn.rs.getInt(3);
         pmtct_DHIS1=""+conn.rs.getInt(4);
...
//               System.out.println("here care......."+facility_id);
         ...
         care_Data=care_711A=care_731=care_DHIS=0;
          care_Data1=""+conn.rs.getInt(1);
          care_711A1=""+conn.rs.getInt(2);
         care_7311=""+conn.rs.getInt(3);
         care_DHIS1=""+conn.rs.getInt(4);
...
//             System.out.println("here tb......."+facility_id);
           ...
           tb_Data1=""+conn.rs.getInt(1);
           tb_711A1=""+conn.rs.getInt(2);
           tb_7311=""+conn.rs.getInt(3);
           tb_DHIS1=""+conn.rs.getInt(4);
